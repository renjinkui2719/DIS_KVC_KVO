//
//  NSDictionary+NSKeyValueCoding.m
//  DIS_KVC_KVO
//
...
#import "NSDictionary+NSKeyValueCoding.h"
        ...
        if([keyPath characterAtIndex:0] == '@') {
            ...
            if(dotRange.length) {
                ...
                if(subKeyPathAfterDot) {
                    ...
                    Method valueForKeyPathMethod = NSKeyValueMethodForPattern(self.class, "%sForKeyPath:", subKeyBeforeDotCStr);
                    if(!valueForKeyPathMethod) {
                        valueForKeyPathMethod = NSKeyValueMethodForPattern(self.class, "_%sForKeyPath:", subKeyBeforeDotCStr);
                    }
                    if(valueForKeyPathMethod) {
