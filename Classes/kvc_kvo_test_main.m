...
#define NSArray_MutByContainer       0
...
void test_kvo() {
        ...
        
    {
        ...
        {
            //====依赖keyPath && 监听传递==
            AFFECTING_KEY_PATH_TEST_ON = YES;
            a = NextRandomA_1;
            a.B_field = B.random;
            a.C_field = C.random;
            a.D_field = D.random;
    ...
    
    {
        ...
        A *a = NextRandomA_1;
        KVONotifyResult *result1 = nil;
        KVONotifyResult *result2 = nil;
